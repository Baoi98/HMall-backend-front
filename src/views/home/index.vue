  ...
  <div class="app-container">
    <div class="address-layout">
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">前端</div>
            <div class="color-main address-content">
              <a href="https://github.com/macrozheng/mall-admin-web">mall</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">学习</div>
            <div class="color-main address-content">
              <a href="https://github.com/macrozheng/mall-learning">mall</a>
            </div>
          </div>
        </el-col>
      </el-row>
    ...
    <el-card class="mine-layout">
      ...
      <div style="text-align: center" v-model="name"></div>
